...
""" This file is for the pfnn with a residual adapter with a full 512x512 matrix of weights for each style."""
...
Xmean.astype(np.float32).tofile('./Parameters/final_nondiag_res/Xmean.bin')
Ymean.astype(np.float32).tofile('./Parameters/final_nondiag_res/Ymean.bin')
Xstd.astype(np.float32).tofile('./Parameters/final_nondiag_res/Xstd.bin')
Ystd.astype(np.float32).tofile('./Parameters/final_nondiag_res/Ystd.bin')
...
def save_network(network):
    ...
    for i in range(50):
        ...
        W0.astype(np.float32).tofile('./Parameters/final_nondiag_res/W0_%03i.bin' % i)
        W1.astype(np.float32).tofile('./Parameters/final_nondiag_res/W1_%03i.bin' % i)
        W2.astype(np.float32).tofile('./Parameters/final_nondiag_res/W2_%03i.bin' % i)
        
        b0.astype(np.float32).tofile('./Parameters/final_nondiag_res/b0_%03i.bin' % i)
        b1.astype(np.float32).tofile('./Parameters/final_nondiag_res/b1_%03i.bin' % i)
        b2.astype(np.float32).tofile('./Parameters/final_nondiag_res/b2_%03i.bin' % i)

        ang_W.astype(np.float32).tofile('./Parameters/final_nondiag_res/ang_W_%03i.bin' % i)
        ang_b.astype(np.float32).tofile('./Parameters/final_nondiag_res/ang_b_%03i.bin' % i)
        chi_W.astype(np.float32).tofile('./Parameters/final_nondiag_res/chi_W_%03i.bin' % i)
        chi_b.astype(np.float32).tofile('./Parameters/final_nondiag_res/chi_b_%03i.bin' % i)
        dep_W.astype(np.float32).tofile('./Parameters/final_nondiag_res/dep_W_%03i.bin' % i)
        dep_b.astype(np.float32).tofile('./Parameters/final_nondiag_res/dep_b_%03i.bin' % i)
        neu_W.astype(np.float32).tofile('./Parameters/final_nondiag_res/neu_W_%03i.bin' % i)
        neu_b.astype(np.float32).tofile('./Parameters/final_nondiag_res/neu_b_%03i.bin' % i)
        old_W.astype(np.float32).tofile('./Parameters/final_nondiag_res/old_W_%03i.bin' % i)
        old_b.astype(np.float32).tofile('./Parameters/final_nondiag_res/old_b_%03i.bin' % i)
        pro_W.astype(np.float32).tofile('./Parameters/final_nondiag_res/pro_W_%03i.bin' % i)
        pro_b.astype(np.float32).tofile('./Parameters/final_nondiag_res/pro_b_%03i.bin' % i)
        sex_W.astype(np.float32).tofile('./Parameters/final_nondiag_res/sex_W_%03i.bin' % i)
        sex_b.astype(np.float32).tofile('./Parameters/final_nondiag_res/sex_b_%03i.bin' % i)
        str_W.astype(np.float32).tofile('./Parameters/final_nondiag_res/str_W_%03i.bin' % i)
        str_b.astype(np.float32).tofile('./Parameters/final_nondiag_res/str_b_%03i.bin' % i)
...
trainer.train(network, E, F, G, filename='./Parameters/final_nondiag_res/network.npz', restart=False, shuffle=False)
end=time.time()
...
np.savez_compressed('./Training_Stats/final_nondiag_res_stats.npz', n_epochs=trainer.total_epochs[1:], train_loss=trainer.train_losses[1:], time=elapsed)
